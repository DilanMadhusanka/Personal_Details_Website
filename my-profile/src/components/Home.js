...
const Home = () => {
    ...
    return (
        <div className="ui container">
            ...
            <h1 className="ui block header" style={style}>
                <img className="ui medium circular image" src={profile} style={{ width: "200px", height: "170px" }} alt="img" />
                <div className="content" style={{marginLeft:"20px"}}>
                    I am Dilan Madhusanka
                    <div className="sub header">Bsc. Honz Software Engineering, University of Kelaniya</div>
                </div>
            </h1>
            </div>
